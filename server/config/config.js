...
var platformConfig = {
  development: {
    ...
    mongo: {
      url: 'mongodb://localhost:27017/nestpad-dev'
    }
  },
  ...
  test: {
    ...
    mongo: {
      url: 'mongodb://localhost:27017/nestpad-test'
    }
  },
  ...
  production: {
    ...
    mongo: {
      url: process.env.MONGOHQ_URL || process.env.MONGOLAB_URI || 'mongodb://localhost:27017/nestpad'
    }
  }
};
